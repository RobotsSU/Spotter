 ...
 * generic types, called <code>Params</code>, <code>Progress</code> and <code>
 * Result</code>, and 4 steps, called <code>begin</code>, <code>doInBackground
 * </code>, <code>processProgress<code>and <code>end</code>.
 * </p>
 *<h2>Usage</h2>
 * <p>
 ...
 * </p>
 *
 * <pre>private class DownloadFilesTask extends UserTask&lt;URL, Integer, Long&gt; { * public File doInBackground(URL... urls) { * int count = urls.length; * long totalSize = 0; * for (int i = 0; i < count; i++) { * totalSize += Downloader.downloadFile(urls[i]); * publishProgress((int) ((i / (float) count) * 100)); * } * } * * public void onProgressUpdate(Integer... progress) { * setProgressPercent(progress[0]); * } * * public void onPostExecute(Long result) { * showDialog("Downloaded " + result + " bytes"); * } * } * </pre>
 *<p>
 * Once created, a task is executed very simply:
 * </p>
 *
 * <pre>new DownloadFilesTask().execute(new URL[] { ... }); * </pre>
 *
 ...
 * </p>
 *
 * <pre>private class MyTask extends UserTask<Void, Void, Void) { ... } * </pre>
 *
 * <h2>The 4 steps</h2>
 * <p>
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                message = sHandler.obtainMessage(
                        MESSAGE_POST_RESULT, new UserTaskResult<Result>(UserTask.this, result));
                message.sendToTarget();
            }
        };
    }
